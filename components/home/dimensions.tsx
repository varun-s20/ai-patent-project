      ...
      >
        {DIMENSIONS.map((d) => (
          <StaggerItem key={d.name} className="h-full">
            <div className="group flex h-full flex-col overflow-hidden rounded-2xl border border-line bg-card transition-shadow duration-500 ease-[var(--ease-out)] hover:shadow-[0_30px_60px_-40px_rgba(26,43,74,0.45)]">
